...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_media_credit_creator_type" AS ENUM('Person', 'Organization');
  ...
  CREATE TABLE "blogs" (
  	...
  	"meta_site_name" varchar DEFAULT '',
  ...
  CREATE TABLE "_blogs_v" (
  	...
  	"version_meta_site_name" varchar DEFAULT '',
  ...
  ALTER TABLE "blogs_populated_authors" ADD CONSTRAINT "blogs_populated_authors_avatar_id_media_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_blogs_v_version_populated_authors" ADD CONSTRAINT "_blogs_v_version_populated_authors_avatar_id_media_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "blogs_populated_authors_avatar_idx" ON "blogs_populated_authors" USING btree ("avatar_id");
  ...
  CREATE INDEX "blogs_meta_meta_image_1_idx" ON "blogs" USING btree ("meta_image_id");
  ...
  CREATE INDEX "_blogs_v_version_populated_authors_avatar_idx" ON "_blogs_v_version_populated_authors" USING btree ("avatar_id");
  ...
  CREATE INDEX "_blogs_v_version_meta_version_meta_image_1_idx" ON "_blogs_v" USING btree ("version_meta_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_media_credit_creator_type";
